...
* 测试情况
* */
public class SEConfigBeanMultiChannelAllValidateTest {
    ...
    public static void main(String[] args) {
        ...
        MultiChannelAllValidate multiChannelAllValidate = new MultiChannelAllValidate("11111111111", "22222222222", "a", "b", "c");
        multiChannelAllValidate.test();
    }
}
